...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * 이 때, 값의 형태에 따라 사용할 수 있는 연산자의 종류와 연산의 결과가 달라진다. */
        ...
        System.out.println(123 / 0.5);
        System.out.println(123 % 0.5);
        // 실수값으로 계산된다. 정수=> 실수로 변경 그리고 실수와 실수의 연산
        ...
        System.out.println("hello" + "world"); //이어붙이기
        ...
        System.out.println("helloworld" + 123); //문자열 + 다른 형태 = 이어붙이기 결과(문자열로 출력)
        System.out.println("hellowirld" + 123.456);
        System.out.println("hellowirld" + 'a');
        System.out.println("hellowirld" + true);
        /* 숫자로 된 문자열 형태의 값은 '+' 연산의 결과가 문자열 합치기 결과가 되는 것에 주의 */
        System.out.println("123" + "456");

        /* 4. 논리값 연산 */
        //논리 값은 연산은 불가능하다.(4-1 ~ 4-4 에러) 단, 문자열과 '+' 가능
        /* 4-1. 논리값과 논리값 연산 */
